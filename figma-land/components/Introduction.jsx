  ...
  return (
    <div className="w-[100%] min-h-[100vh] bg-[#222B32] max-[600px]:min-h-[50vh]">
      ...
      <div className="w-[100%] h-[100%]  flex justify-center items-center">
        <div className=" w-[40%] min-h-[70%]  mx-auto mt-[100px] flex flex-col justify-center items-center max-[1700px]:w-[60%] max-[1100px]:w-[80%] max-[800px]:h-[100%] max-[600px]:mt-[80px]">
